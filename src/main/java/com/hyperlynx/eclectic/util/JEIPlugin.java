...
public class JEIPlugin implements IModPlugin {
    ...
    public void registerRecipes(@NotNull IRecipeRegistration registration) {
        ...
        registration.addIngredientInfo(new ItemStack(Registration.WEEPING_OBSIDIAN_ITEM.get()), VanillaTypes.ITEM_STACK,
        ...
        registration.addIngredientInfo(new ItemStack(Registration.SOBBING_OBSIDIAN_ITEM.get()), VanillaTypes.ITEM_STACK,
                Component.nullToEmpty("The rain has dampened its mood. Best to let it dry out in the sun."));
        registration.addIngredientInfo(new ItemStack(Registration.RAGING_OBSIDIAN_ITEM.get()), VanillaTypes.ITEM_STACK,
        ...
        registration.addIngredientInfo(new ItemStack(Registration.MOURNING_OBSIDIAN_ITEM.get()), VanillaTypes.ITEM_STACK,
                Component.nullToEmpty("The fires of rage have given way to grief. Maybe the light of the sun will allow it to finally heal."));
        registration.addIngredientInfo(new ItemStack(Registration.MOVING_OBSIDIAN_ITEM.get()), VanillaTypes.ITEM_STACK,
                Component.nullToEmpty("Mournful grief is set to motion by a place filled with spirits. It wanders aimlessly through the open air. Return it to the void to let it rest."));
        registration.addIngredientInfo(new ItemStack(Registration.DEAD_OBSIDIAN_ITEM.get()), VanillaTypes.ITEM_STACK,
                Component.nullToEmpty("It's gone."));
        registration.addIngredientInfo(new ItemStack(Registration.PHANTOM_QUILT_ITEM.get()), VanillaTypes.ITEM_STACK,
        ...
        registration.addIngredientInfo(new ItemStack(Registration.SCONCE_ITEM.get()), VanillaTypes.ITEM_STACK,
                Component.nullToEmpty("A decorative sconce. By applying different items, it changes form. These items can be used: \n\nAmethyst Shard\nGlowstone Dust\nBlaze Powder\nSoul Soil"));
        registration.addIngredientInfo(new ItemStack(Registration.MIND_LANTERN_ITEM.get()), VanillaTypes.ITEM_STACK,
        ...
        registration.addIngredientInfo(new ItemStack(Registration.HAMMER_ITEM.get()), VanillaTypes.ITEM_STACK,
